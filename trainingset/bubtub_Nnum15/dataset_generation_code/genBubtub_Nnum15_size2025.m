...
synthetic.Height = 2025; % volume height
synthetic.Width = 2025; % volume width
...
savefolder = ['../'];
load('../../../psf/debye_integral_0_group0_aberration_induced0_circleAperture1_pupilMask1_PhazeSpacePSF_M20_NA1.05_n1.406_lambda525nm_fml536.4u_ftl180000u_zmin-30u_zmax30u_zspacing0.6u.mat');
...
blur_sigmas_list = [linspace(0.5, 3, 6), linspace(0.5, 1.5, 3), linspace(0.5, 3, 6)];
...
for this = 1:15
    ...
    if num_bubbles > 0
        ...
        for idx = 1:length(index_c)-1
            ...
            relativeinds = getbubbleinds(rxy,rz,synthetic.Height,synthetic.Width,synthetic.Depth);
            relativeinds_beads = getbeadinds(rxy,rz,synthetic.Height,synthetic.Width,synthetic.Depth);
    ...
    imwrite3d(uint16(x3),[savefolder,tag,'/x3_synthetic/group',num2str(this,'%03d'),'.tif'],16);
    tt = toc;
