...
num_lines_list = repmat(num_lines_list, [1,20]);
num_bubbles_list = [(1:6)*0, linspace(200, 100, 3),(1:6)*0];
num_bubbles_list = repmat(num_bubbles_list, [1,20]);
num_beads_list = [(1:9)*0, linspace(5000, 1000, 5), 0];
num_beads_list = repmat(num_beads_list, [1,20]);
num_big_beads_list = [(1:14)*0, 50];
num_big_beads_list = repmat(num_big_beads_list, [1,20]);
bubble_diameter_list = [20,35,50,20,35,50,20,35,50,20,35,50,20,35,50];
bubble_diameter_list = repmat(bubble_diameter_list, [1,20]);

blur_sigmas_list = [linspace(0.5, 3, 6), linspace(0.5, 1.5, 3), linspace(0.5, 3, 6)];
blur_sigmas_list = repmat(blur_sigmas_list, [1,20]);
radius_pixel_num_list = repmat([1,1,2,2,3,3],  [1,50]);
