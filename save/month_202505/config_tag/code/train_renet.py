# SeReNet can also be trained in a supervised way 
# kimchange
import argparse
import os,sys
...
def train(train_loader, model, optimizer):
    ...
    for batch in tqdm(train_loader, leave=False, desc='train', ncols=0):
        ...
        # batch['inp'] = batch['inp']*rand_factor + rand_bg * global_psf_sumdhw.reshape(1, -1, 1, 1)
        ...
        loss = loss_fns['pixel_loss1'](pred.squeeze(1), batch['volume'] + rand_bg)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/train-renet/renet_Nnum13_bubtub.yaml')
